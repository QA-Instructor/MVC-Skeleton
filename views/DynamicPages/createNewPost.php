<header><h1>Create New ADVNTR post</h1>
...
<form action="" method="POST" class="fluid-container" enctype="multipart/form-data">
    <div class="bg-img">
        ...
        <div class="container">
            ...
            <pre><label for="content">Content</label><br>
            <textarea id="content" name="content" rows="10" cols="40" required></textarea><pre><br><br>
