...
<!--We need the meta tag to properly scale the responsive CSS code-->
  ...
  <div class="container">
    ...
    <p class="lead">Our blog is not just about photography, it will take you on a journey of culture, food, history and beyond</p>
  </div>
</div>
            ...
            <div class="card-deck">
                ...
                <div class="card  mb-4 border-0">
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <a href="?controller=blog&action=readAll" >See all blogs...</a>
                    </div>
                </div>
                <div class="card mb-4 border-0">
